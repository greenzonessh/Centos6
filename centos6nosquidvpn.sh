...
# install screenfetch
cd
wget http://128.199.208.185:81/centos6/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "http://128.199.208.185:81/centos6/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>GREENZONESSH</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "http://128.199.208.185:81/centos6/vps.conf"
...
#wget -O /etc/openvpn/1194.conf "http://128.199.208.185:81/centos6/1194-centos.conf"
...
#cd /etc/openvpn/
#wget -O /etc/openvpn/1194-client.ovpn "http://128.199.208.185:81/centos6/1194-client.conf"
...
# install PPTP VPN
yum install -y git
wget -O vpn-setup-vanilla.sh "http://128.199.208.185:81/centos6/vpn-setup-vanilla.sh"
...
# download script
cd
wget -O speedtest_cli.py "http://128.199.208.185:81/centos6/speedtest_cli.py"
wget -O bench-network.sh "http://128.199.208.185:81/centos6/bench-network.sh"
wget -O ps_mem.py "http://128.199.208.185:81/centos6/ps_mem.py"
wget -O /usr/bin/user-expire.sh "http://128.199.208.185:81/centos6/user-expire.sh"
wget -O user-list "http://128.199.208.185:81/centos6/user-list"
wget -O user-login.sh "http://128.199.208.185:81/centos6/user-login.sh"
