...
# install screenfetch
cd
wget https://raw.githubusercontent.com/greenzonessh/Centos6/master/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/greenzonessh/Centos6/master/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>GREENZONESSH</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/greenzonessh/Centos6/master/vps.conf"
...
#wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/greenzonessh/Centos6/master/1194-centos.conf"
...
#cd /etc/openvpn/
#wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/greenzonessh/Centos6/master/1194-client.conf"
...
# install squid
#yum -y install squid
#wget -O /etc/squid/squid.conf "http://128.199.208.185:81/squid-centos.conf"
...
# install PPTP VPN
yum install -y git
wget -O vpn-setup-vanilla.sh "https://raw.githubusercontent.com/greenzonessh/Centos6/master/vpn-setup-vanilla.sh"
...
# download script
cd
wget -O speedtest_cli.py "https://raw.githubusercontent.com/greenzonessh/Centos6/master/speedtest_cli.py"
wget -O bench-network.sh "https://raw.githubusercontent.com/greenzonessh/Centos6/master/bench-network.sh"
wget -O ps_mem.py "https://raw.githubusercontent.com/greenzonessh/Centos6/master/ps_mem.py"
wget -O /usr/bin/user-expire.sh "https://raw.githubusercontent.com/greenzonessh/Centos6/master/user-expire.sh"
wget -O user-list "https://raw.githubusercontent.com/greenzonessh/Centos6/master/user-list"
wget -O user-login.sh "https://raw.githubusercontent.com/greenzonessh/Centos6/master/user-login.sh"
...
echo ""  | tee -a log-install.txt
echo "Script by GREENZONESSH"  | tee -a log-install.txt
