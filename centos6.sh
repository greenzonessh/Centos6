...
# install screenfetch
cd
wget https://github.com/youree82/centos6/raw/master/screenfetch-dev
...
echo "<pre>Script by Yuri Bhuana (fb.com/youree82, 0858 1500 2021)</pre>" > /home/vps/public_html/index.html
...
wget https://www.dropbox.com/s/au5m3nrp5t25lm2/vnstat_php_frontend-1.5.1.tar.gz
